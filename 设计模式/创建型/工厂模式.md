...
class PHPerAR implements Programmer
{

    public function code()
    {
        echo "This is PHPer, which works for AR";
    }
}

class PHPerAI implements Programmer
{

    public function code()
    {
        echo "That is PHPer, which works for AI";
    }
}

class JAVAerAR implements Programmer
{

    public function code()
    {
        echo "JAVAer works for AR";
    }
}

class JAVAerAI implements Programmer
{

    public function code()
    {
        echo "PHP works for AI";
    }
}
...
class Coder
{
    ...
    public function test()
    {
        $php = ( new PHPerBigData() )->ai();
        $php->code();
        $php = ( new PHPerBigData() )->ar();
        $php->code();

        $java = ( new JAVAerBigData() )->ai();
        $java->code();
        $java = ( new JAVAerBigData() )->ar();
        $java->code();
    }
}
